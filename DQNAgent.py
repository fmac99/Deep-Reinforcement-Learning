...
from DuelingDQN import Network
...
#change epsilon to .01 during testing
#Hyperparameters
...
class BananaCollector():
    def __init__(self,state_size,action_size,seed):
        #state space dim, action space dim, random seed
        self.state_size = state_size
        self.action_size = action_size
        self.seed = random.seed(seed)
        #Q Network
        self.qnet_local = Network(self.state_size,self.action_size,self.seed).to(device)
        self.qnet_target = Network(self.state_size,self.action_size,self.seed).to(device)
        # Optimizer
